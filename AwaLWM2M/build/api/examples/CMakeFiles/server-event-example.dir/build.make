...
api/examples/CMakeFiles/server-event-example.dir/server-event-example.c.o: ../api/examples/server-event-example.c
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Building C object api/examples/CMakeFiles/server-event-example.dir/server-event-example.c.o"
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -o CMakeFiles/server-event-example.dir/server-event-example.c.o   -c /home/tusnio/ci40_project/awacontiki/AwaLWM2M/api/examples/server-event-example.c
...
api/examples/CMakeFiles/server-event-example.dir/server-event-example.c.i: cmake_force
	...
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -E /home/tusnio/ci40_project/awacontiki/AwaLWM2M/api/examples/server-event-example.c > CMakeFiles/server-event-example.dir/server-event-example.c.i
...
api/examples/CMakeFiles/server-event-example.dir/server-event-example.c.s: cmake_force
	...
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -S /home/tusnio/ci40_project/awacontiki/AwaLWM2M/api/examples/server-event-example.c -o CMakeFiles/server-event-example.dir/server-event-example.c.s
...
api/examples/server-event-example: api/examples/CMakeFiles/server-event-example.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --red --bold "Linking C executable server-event-example"
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/server-event-example.dir/link.txt --verbose=$(VERBOSE)
...
api/examples/CMakeFiles/server-event-example.dir/clean:
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples && $(CMAKE_COMMAND) -P CMakeFiles/server-event-example.dir/cmake_clean.cmake
.PHONY : api/examples/CMakeFiles/server-event-example.dir/clean

api/examples/CMakeFiles/server-event-example.dir/depend:
	cd /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/tusnio/ci40_project/awacontiki/AwaLWM2M /home/tusnio/ci40_project/awacontiki/AwaLWM2M/api/examples /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples /home/tusnio/ci40_project/awacontiki/AwaLWM2M/build/api/examples/CMakeFiles/server-event-example.dir/DependInfo.cmake --color=$(COLOR)
